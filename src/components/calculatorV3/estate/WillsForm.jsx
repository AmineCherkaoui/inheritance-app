  ...
  return (
    <div className="flex flex-col gap-4 bg-white/50 p-4 rounded-xl  border border-primary-950/10">
      ...
      <div className="space-y-1">
        <label className=" text-primary-950 font-bold  flex items-center gap-2 justify-start text-right">
          <ScrollText size={20} />
          <span>الوصايا </span>
        </label>
      </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center rounded-xl">
                <div className="flex-1 relative">
                  <input
                    ...
                    onChange={(e) =>
                      updateWill(will.id, "name", e.target.value)
                    }
                ...
                <div className="sm:w-56">
                  ...
                  >
                    ...
                    <Select.Popover>
                      <ListBox>
                        <ListBox.Item id="1/2" textValue="1/2 (النصف)">
                          1/2 (النصف)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/3" textValue="1/3 (الثلث)">
                          1/3 (الثلث)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/4" textValue="1/4 (الربع)">
                          1/4 (الربع)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/5" textValue="1/5 (الخمس)">
                          1/5 (الخمس)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/6" textValue="1/6 (السدس)">
                          1/6 (السدس)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/7" textValue="1/7 (السبع)">
                          1/7 (السبع)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/8" textValue="1/8 (الثمن)">
                          1/8 (الثمن)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/9" textValue="1/9 (التسع)">
                          1/9 (التسع)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/10" textValue="1/10 (العشر)">
                          1/10 (العشر)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/12" textValue="1/12 (جزء من 12)">
                          1/12 (جزء من 12)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/16" textValue="1/16 (جزء من 16)">
                          1/16 (جزء من 16)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="1/24" textValue="1/24 (جزء من 24)">
                          1/24 (جزء من 24)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="2/3" textValue="2/3 (الثلثين)">
                          2/3 (الثلثين)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                        <ListBox.Item id="3/4" textValue="3/4 (ثلاثة أرباع)">
                          3/4 (ثلاثة أرباع)
                          <ListBox.ItemIndicator />
                        </ListBox.Item>
                      </ListBox>
