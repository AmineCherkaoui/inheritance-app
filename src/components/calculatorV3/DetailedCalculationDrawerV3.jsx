...
import { ScrollText, X, Sparkles, CheckCircle2, Scale } from 'lucide-react';
...
export default function DetailedCalculationDrawerV3({ result, isOpen, onOpenChange }) {
    ...
    <Drawer.Backdrop isOpen={isOpen} onOpenChange={onOpenChange}>
      <Drawer.Content placement="right" className="max-w-full w-full h-full ">
        ...
        >
          ...
          <div className=" relative pb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-right">
                <Drawer.Heading className="text-base sm:text-lg font-black text-primary-950">
                  خطوات الحل والشرح الفقهي التفصيلي
                </Drawer.Heading>
          ...
          {/* Body */}
          <Drawer.Body className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
            {/* Case Summary Card */}
            {heirsSummary && (
